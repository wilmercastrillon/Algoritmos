...
const lli INFFLUJO=1e14, INFCOSTO=1e14, MAXN = 100010;
lli dist[MAXN], min_cost, cap[MAXN], max_flow;
int n, pre[MAXN];  bool en_cola[MAXN];
...
int main(){
    lli m,a,b,k,z,x,y, start, target, capacidad, costo;
